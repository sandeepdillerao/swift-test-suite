// Electron-specific Tailwind config.
// Uses absolute content paths so Tailwind JIT works regardless of CWD,
// and CJS syntax so require('tailwindcss-animate') doesn't break in ESM context.
